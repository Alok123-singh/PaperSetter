...
function Home() {
    return (
        <div className = 'py-10 flex justify-around items-center dark:bg-gray-400  flex-wrap'>
            ...
            <div class="w-[270px] rounded-md border-2 border-gray-300 dark:border-gray-600 flex flex-col justify-center items-center">
                <img
                ...
                <div class="p-3 flex flex-col justify-center items-center">
                    <h1 class="text-md  font-semibold">Query Game</h1>
