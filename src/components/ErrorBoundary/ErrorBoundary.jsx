...
function ErrorBoundary(props) {
    ...
    if (hasError) {
        ...
        { header: 'Error Message', dataKey: 'errorMessage', dataRender: (index, errorMessage) => <div>{errorMessage.toString()}</div> },
        ...
        <div className="w-full h-screen flex justify-center items-center error-page">
            ...
            <div className="w-full flex flex-col justify-center items-center font-bold text-lg">
                ...
                <h1 className="mt-4 mb-2 text-xl">Oops something went wrong. Please try again</h1>
