...
import { Loading, TablePagination, OverlayForm1, Input } from '../../../components/index'
...
function InstructorHome() {
    ...
    const parseDateAndTime = (dateAndTime) => {
        ...
        // Note: Months are zero-based in JavaScript, so we subtract 1 from the parsed month
        const parsedDate = new Date(Number(year), Number(month) - 1, Number(day), hourValue, Number(minutes));
        ...
        { // Name
            ...
            dataRender: (index, value, currentItem) => {
                ...
                return  <div className='flex justify-center items-center'>
                            ...
                            <a 
                            href={`/instructor/courses?${queryString}`}
                            target='_blank'
